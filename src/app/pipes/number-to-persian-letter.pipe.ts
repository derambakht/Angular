...
@Pipe({
  name: 'numberToLetterPersian'
})
export class NumberToPersianLetterPipe implements PipeTransform {
  constructor(){}
  transform(value: number): any {
    var service = new NumberToPersianWord();
    return service.convertNumberToString(value);
  }
}
